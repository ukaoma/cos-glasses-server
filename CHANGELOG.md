...
Not published. The release renames this heading to `## 6.52.0` together with the package.json bump; until then the newest version heading stays the published 6.51.0, which `package-manifest.test.ts` pins.
