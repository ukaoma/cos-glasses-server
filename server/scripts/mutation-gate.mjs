...
const CASES = [
  ...
  // ─── 6.52.0: the Messages trail ───
  {
    ...
    find: '  return redactQueryJobText(redactSecretText(plain))\n',
    replace: '  return redactQueryJobText(plain)\n',
  ...
  },
  {
    ...
    file: 'server/lib/job-trail.ts',
    find: '  return redactQueryJobText(redactSecretText(plain))\n',
    replace: '  return redactSecretText(plain)\n',
  ...
  },
  {
    ...
    file: 'server/lib/job-trail.ts',
    find: "    if (draft.kind === 'tool') return null\n",
    replace: '',
  ...
  },
  {
    ...
    file: 'server/lib/job-trail.ts',
    find: '    return draft.tool_outcome ? null : draft\n',
  ...
  },
  {
    ...
    file: 'server/lib/query-job-store.ts',
    find: '      const trailSeq = hydrated.trailSeq + 1\n',
    replace: '      const trailSeq = hydrated.snapshot.eventSeq + 1\n',
  ...
  },
  {
    ...
    file: "server/lib/permission-broker.ts",
    find: "    if (polledAt === null || now - polledAt > CLIENT_LIVE_WINDOW_MS) return this.noteFastPath('no_client')",
  ...
  },
  {
    ...
    file: "server/lib/permission-broker.ts",
    find: "    if (polledAt === null || now - polledAt > CLIENT_LIVE_WINDOW_MS) return this.noteFastPath('no_client')",
    replace: "    if (polledAt === null) return this.noteFastPath('no_client')",
    tests: ["server/lib/permission-broker.test.ts", "server/routes/permission-broker.test.ts"],
  },
  {
    name: "broker-desk-active-parks",
    file: "server/lib/permission-broker.ts",
    find: "    if (idle < this.deps.deskIdleSeconds()) return this.noteFastPath('desk_active')",
  ...
  },
  {
    ...
    file: "server/lib/permission-broker.ts",
    find: "    if (idle !== null && idle >= this.deps.deskIdleSeconds()) return\n    this.settleAll('handed_to_desk')",
    replace: "    return\n    this.settleAll('handed_to_desk')",
    tests: ["server/lib/permission-broker.test.ts", "server/routes/permission-broker.test.ts"],
  },
  {
  ...
  },
  {
    ...
    file: "server/lib/permission-broker.ts",
    find: "    if (polledAt === null || now - polledAt > CLIENT_LIVE_WINDOW_MS) return this.noteFastPath('no_client')",
    replace: "    if (polledAt === null || now - polledAt >= CLIENT_LIVE_WINDOW_MS) return this.noteFastPath('no_client')",
    tests: ["server/lib/permission-broker.test.ts", "server/routes/permission-broker.test.ts"],
  },
  {
    ...
    file: "server/lib/permission-broker.ts",
    find: "    if (polledAt === null || now - polledAt > CLIENT_LIVE_WINDOW_MS) return this.noteFastPath('no_client')",
    replace: "    if (polledAt === null || now - polledAt > 2 * CLIENT_LIVE_WINDOW_MS) return this.noteFastPath('no_client')",
    tests: ["server/lib/permission-broker.test.ts", "server/routes/permission-broker.test.ts"],
  },
  {
    name: "liveness-poll-moves-backwards",
    file: "server/lib/client-liveness.ts",
    find: "  if (lastPollAt === null || at > lastPollAt) lastPollAt = at",
    replace: "  lastPollAt = at",
    tests: ["server/lib/permission-broker.test.ts"],
  },
  {
    name: "hook-script-posts-old-url",
    file: "bin/hooks/cos-session-hook",
    find: "\"http://127.0.0.1:$PORT/hooks/permission-requests/ask\"",
    replace: "\"http://127.0.0.1:$PORT/api/permission-requests/ask\"",
    tests: ["server/lib/cos-session-hook.script.test.ts"],
  },
