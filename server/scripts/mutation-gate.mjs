...
const CASES = [
  ...
  },
  {
    ...
    file: "server/lib/permission-broker.ts",
    find: "    if (seenAt === null || now - seenAt > CLIENT_LIVE_WINDOW_MS) return this.noteFastPath('no_client')",
  ...
  },
  {
    ...
    file: "server/lib/permission-broker.ts",
    find: "    if (seenAt === null || now - seenAt > CLIENT_LIVE_WINDOW_MS) return this.noteFastPath('no_client')",
    replace: "    if (seenAt === null) return this.noteFastPath('no_client')",
    tests: ["server/lib/permission-broker.test.ts", "server/routes/permission-broker.test.ts"],
  },
  {
  ...
  {
    name: "liveness-claims-unnoted",
    file: "server/routes/client-instance.ts",
    find: "    noteClientClaim(at)\n",
    replace: "\n",
    tests: ["server/routes/permission-broker.test.ts"],
  },
  {
