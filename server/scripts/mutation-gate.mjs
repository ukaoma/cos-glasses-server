...
const CASES = [
  ...
  },
  {
    ...
    file: 'server/lib/client-instance-claim.ts',
    find: "  if (evidence.claimant && !evidence.owner) return { owner: fresh, verdict: 'owner', took: true }\n",
    replace: "\n",
    tests: ['server/routes/client-instance.test.ts'],
  },
  {
    ...
    file: 'server/lib/client-instance-claim.ts',
    find: "  if (evidence.claimant && !evidence.owner) return",
    replace: "  if (evidence.claimant) return",
    tests: ['server/routes/client-instance.test.ts'],
  },
  {
    name: 'referee-dead-owner-pinned-by-untagged',
    file: 'server/lib/client-instance-claim.ts',
    find: "  return evidence.untagged && now - owner.seenAt <= CLIENT_INSTANCE_LIVE_MS\n",
    replace: "  return evidence.untagged\n",
    tests: ['server/routes/client-instance.test.ts'],
  },
  {
